...
<body>
    ...
    <div class="container">
        ...
        <table class="table">
         <caption> Aceptación Practicas Profesionales </caption>
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Directivo</th>
            ...
            <tbody>
                ...
                $consulta = "SELECT * FROM aceptacion_pp LIMIT $inicio, $registrosPorPagina";
                ...
                while ($fila = mysqli_fetch_assoc($resultado)) {
                    ...
                    echo "<td>" . $fila["dj"] . "</td>";
                    echo '<td>
                        <button class="btn-seleccionar" data-id="' . $fila['Id_pp'] . '"><img src="iconos/doc.svg" alt="Icono" class="icono-svg"></button>
                    ...
                    botonesEditar.forEach(function(boton) {
                        boton.addEventListener('click', function() {
                            ...
                            if (confirm('¿Estás seguro de que deseas editar este registro?')) {
                                ...
                                window.location.href = 'edit_pp.php?id=' + idSeleccionado;
                            }
                        });
                    });
                </script>
                    ...
                    botonesEliminar.forEach(function(boton) {
                        boton.addEventListener('click', function() {
                            ...
                            if (confirm('¿Estás seguro de que deseas eliminar este registro?')) {
                                ...
                                window.location.href = 'delete_pp.php?id=' + idSeleccionado;
                            }
                        });
                    });
                </script>
                ...
                <script>
                    ...
                    botonesSeleccionar.forEach(function(boton) {
                        boton.addEventListener('click', function() {
                            ...
                            window.location.href = 'G_Doc_pp.php?id=' + idSeleccionado;
                        });
                    });
                </script>
            </tbody>
        ...
        <div class="pagination">
            ...
            $consultaTotal = "SELECT COUNT(*) as total FROM aceptacion_pp";
