...
<body>
  ...
  <table class="table">
            <caption> Aceptación Estadia Profesional</caption>
            <thead>
                <tr>
                <th>ID</th>
                    <th>Directivo</th>
        ...
        <tbody>
            <?php
                ...
                $consulta = "SELECT * FROM aceptacion_ep LIMIT $inicio, $registrosPorPagina";
                ...
                $resultado = mysqli_query($getconex, $consulta);
                    ...
                    while ($fila = mysqli_fetch_assoc($resultado)) {
                        echo "<tr>";
                        echo "<td style='width: 10px;'>{$fila['id_ep']}</td>";
                        echo "<td>" . $fila["nombreExpide"] . "</td>";
                        echo "<td>" . $fila["cargoP"] . "</td>";
                        
                        echo "<td>" . $fila["nombrePrestatario"] . "</td>";
                        echo "<td>" . $fila["nombreLic"] . "</td>";
                        ...
                        echo "<td>" . $fila["dj"] . "</td>";
                        echo '<td><button class="btn-seleccionar" data-id="' . $fila['id_ep'] . '"><img src="iconos/doc.svg" alt="Icono" class="icono-svg"></button>
                        <button class="btn-editar" data-id="' . $fila['id_ep'] . '">
                        <img src="iconos/edit.svg" alt="Icono" class="icono-svg">
                        </button>
                        <button class="btn-eliminar" data-id="' . $fila['id_ep'] . '">
                ...
                botonesEditar.forEach(function (boton) {
                    boton.addEventListener('click', function () {
                        ...
                        if (confirm('¿Estás seguro de que deseas editar este registro?')) {
                            ...
                            window.location.href = 'edit_ep.php?id=' + idSeleccionado;
                        }
                    });
                });
                </script>
            ...
            botonesEliminar.forEach(function (boton) {
                boton.addEventListener('click', function () {
                    ...
                    if (confirm('¿Estás seguro de que deseas eliminar este registro?')) {
                        ...
                        window.location.href = 'delete_ep.php?id=' + idSeleccionado;
                    }
                });
            });
            </script>
            ...
            botonesSeleccionar.forEach(function (boton) {
                ...
                window.location.href = 'G_Doc_ep.php?id=' + idSeleccionado;
                });
            });
            </script>
        ...
        //Consulta SQL para obtener el número total de registros
                    $consultaTotal = "SELECT COUNT(*) as total FROM aceptacion_ep";
