...
<body>
  ...
  <table class="table">
            <caption>Terminación Estadia Profesional</caption>
            <thead>
                <tr>
                <th>ID</th>
                    <th>Directivo</th>
        ...
        <tbody>
            <?php
                ...
                $consulta = "SELECT * FROM terminacion_ep LIMIT $inicio, $registrosPorPagina";
                ...
                $resultado = mysqli_query($getconex, $consulta);
                    ...
                    while ($fila = mysqli_fetch_assoc($resultado)) {
                        ...
                        echo '<td><button class="btn btn-seleccionar" data-id="' . $fila['Id_ep'] . '"><img src="iconos/lib.svg" alt="Icono" class="icono-svg"></button>
                ...
                botonesEditar.forEach(function (boton) {
                    boton.addEventListener('click', function () {
                        ...
                        if (confirm('¿Estás seguro de que deseas editar este registro?')) {
                            ...
                            window.location.href = 'edit_ep_lib.php?id=' + idSeleccionado;
                        }
                    });
                });
                </script>
            ...
            botonesEliminar.forEach(function (boton) {
                boton.addEventListener('click', function () {
                    ...
                    if (confirm('¿Estás seguro de que deseas eliminar este registro?')) {
                        ...
                        window.location.href = 'delete_ep_lib.php?id=' + idSeleccionado;
                    }
                });
            });
            </script>
            ...
            botonesSeleccionar.forEach(function (boton) {
                ...
                window.location.href = 'G_Doc_ep_lib.php?id=' + idSeleccionado;
                });
            });
            </script>
        ...
        //Consulta SQL para obtener el número total de registros
                    $consultaTotal = "SELECT COUNT(*) as total FROM terminacion_ep";
