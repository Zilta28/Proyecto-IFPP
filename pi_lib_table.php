...
<body>
  ...
  <table class="table">
            <caption>Terminación Proyecto de Intervención</caption>
            <thead>
                <tr>
                <th>ID</th>
                    <th>Directivo</th>
        ...
        <tbody>
            <?php
                ...
                $consulta = "SELECT * FROM terminacion_pi LIMIT $inicio, $registrosPorPagina";
                ...
                $resultado = mysqli_query($getconex, $consulta);
                    ...
                    while ($fila = mysqli_fetch_assoc($resultado)) {
                        echo "<tr>";
                        echo "<td style='width: 10px;'>{$fila['Id_pi']}</td>";
                        ...
                        echo '<td>
                        <button class="btn btn-seleccionar" data-id="' . $fila['Id_pi'] . '"><img src="iconos/lib.svg" alt="Icono" class="icono-svg"></button>
                        <button class="btn-editar" data-id="' . $fila['Id_pi'] . '">
                        <img src="iconos/edit.svg" alt="Icono" class="icono-svg">
                        </button>
                        <button class="btn-eliminar" data-id="' . $fila['Id_pi'] . '">
                ...
                botonesEditar.forEach(function (boton) {
                    boton.addEventListener('click', function () {
                        ...
                        if (confirm('¿Estás seguro de que deseas editar este registro?')) {
                            ...
                            window.location.href = 'edit_pi_lib.php?id=' + idSeleccionado;
                        }
                    });
                });
                </script>
            ...
            botonesEliminar.forEach(function (boton) {
                boton.addEventListener('click', function () {
                    ...
                    if (confirm('¿Estás seguro de que deseas eliminar este registro?')) {
                        ...
                        window.location.href = 'delete_pi_lib.php?id=' + idSeleccionado;
                    }
                });
            });
            </script>
            ...
            botonesSeleccionar.forEach(function (boton) {
                ...
                window.location.href = 'G_Doc_pi_lib.php?id=' + idSeleccionado;
                });
            });
            </script>
        ...
        //Consulta SQL para obtener el número total de registros
                    $consultaTotal = "SELECT COUNT(*) as total FROM terminacion_pi";
